...
# Prev update: 2025-04-18(Fri) 05:33 JST / 2025-04-17(Thu) 20:33 UTC
...
xxx_PING="send-ping.sh"
xxx_OFFSET="send-offset.sh"
...
z=""
[ -z "$z" ] && x=$(find . -name "$xxx_PING" -type f -perm -100) && [ ! -z $x ] && z="$x"
[ -z "$z" ] && x=$(which "$xxx_PING") &&  [ ! -z $x ] && z="$x"
[ -z "$x" ] && x=$(find . -name "$xxx_PING" -type f) && [ ! -z $x ] && z="sh $x"
[ -z "$x" ] && x=$(find -L . -name "$xxx_PING" -type f) && [ ! -z $x ] && z="sh $x"
[ -z "$z" ] && echo "NG: Can't find $xxx_PING" && exit 1
CMD_PING="$z"

z=""
[ -z "$z" ] && x=$(find . -name "$xxx_OFFSET" -type f -perm -100) && [ ! -z $x ] && z="$x"
[ -z "$z" ] && x=$(which "$xxx_OFFSET") &&  [ ! -z $x ] && z="$x"
[ -z "$x" ] && x=$(find . -name "$xxx_OFFSET" -type f) && [ ! -z $x ] && z="sh $x"
[ -z "$x" ] && x=$(find -L . -name "$xxx_OFFSET" -type f) && [ ! -z $x ] && z="sh $x"
[ -z "$z" ] && echo "NG: Can't find $xxx_OFFSET" && exit 2
CMD_OFFSET="$z"
